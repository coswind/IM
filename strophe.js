...
if (callback) {
    ...
    Strophe.$build = arguments[1];
    Strophe.$msg = arguments[2];
    Strophe.$iq = arguments[3];
    Strophe.$pres = arguments[4];
});
